...
const OurProducts : React.FC = () => {
    return (
        <section className="width-full flex flex-col items-center pt-[70px] ">
            <div className=" font-bold text-[32px] leading-[38.73px] text-[#616161] pb-[40px]" > our products </div>
            ...
            <ProductDes image={eazymock} product="EazyMock" description="Create and manage mock APIs to develop and test app’s interaction" imageTotal={eazyProcessImage} />
